...
export default function () {
  ...
  const handleSignup = async () => {
    try {
      ...
      const response = await axios.post(
        `${baseUrl}/api/website/front/user/register`,
        {
          username: username,
  ...
  const handleOtpVerification = async () => {
    try {
      ...
      setLoading(true);
      const response = await axios.post(
        `${baseUrl}/api/website/front/user/register_verify`,
        {
          otp: otp,
          phone_number: phoneNumber,
        },
  ...
  const handleGoogleLogin = () => {
    signInWithPopup(auth, provider).then(async (res) => {
      ...
      try {
        ...
        setLoading(true);
        const response = await axios.post(
          `${baseUrl}/api/website/front/user/create/newuser/web`,
          {
        ...
        <div className="form-container sign-in-container">
          {/* {!showOtp ? ( */}
            <div className="loginform">
              ...
              <Link href="/login">
                <p className="loginlink">Already have account? <span><b>Login</b></span></p>
              </Link>
