...
export default function () {
  ...
  const fetchData = async (limit__, page__) => {
    try {
      // setLoading(true);
      const url = `${baseUrl}/api/website/front/get/product/trending/all?limit=${limit__}&page=${page__}`;
  ...
  return (
    <LayoutOne title="Shop Fullwidth Left Sidebar">
      <Breadcrumb title="Trending Products">
        <BreadcrumbItem name="Home" path={"/"} />
        <BreadcrumbItem name="Trending Products" current />
      </Breadcrumb>
