      ...
      {numSelected > 0 ? (
        ...
        >
          <Typography
            ...
            component="div"
          >
            {`All Bulk Enquiries (${props.countVendor})`}
          </Typography>
...
export default function BulkEnquiry() {
  ...
  const [modalenquiryData, setmodalenquiryData] = useState({});
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/website/front/get/all/bulk/inquiry?page=${currentPage}`,
        {
          headers: {
      ...
      .then((res) => {
        ...
        setData(res?.data?.all_enquiry);
        setCountVendor(res?.data?.enquiry_count || 0);
  ...
  const handleDeleteEnquiry = async (value) => {
    console.log("VALUE FOR DELETE=>", value);
    await axios
      .post(
        `${process.env.REACT_APP_BACKEND_URL}/api/website/front/get/delete/bulk/inquiry`,
        { data: value },
        {
          headers: {
            Authorization: `token ${editable_config.FRONTEND_VALIDATOR}`,
  ...
  //############################# PREVIEW ENQUIRE MODAL FUNCTION #############################
  const handleClosePopupModal = () => {
    setOpenPopupModal(false);
    // setIsOpen2(false)
    onYesFunction();
  };
  const handleOpenPopupModal = (value) => {
    setOpenPopupModal(true);
    setmodalenquiryData(value);
    // setIsOpen2(false)
  };
  ...
  return (
    <>
      ...
      <PopupModal
        ...
        data={
          <EnquiryPreview
            data={modalenquiryData}
            handleClose={handleClosePopupModal}
            onYes={onYesFunction}
            confirmBtnName="Image Compress Now"
            title="Reduce Image Size!! "
            message="Thanks, your plan has been upgraded succesfully!!"
          />
        }
      />
      {/*===== Popup Modal ====== */}
      ...
      <ConfimModal
        ...
        onYes={() => handleDeleteEnquiry(selected)}
        message="Are you sure you want to delete enquiries?"
                          ...
                          >
                            ...
                            <TableCell align="center">
                              ...
                              <VisibilityIcon
                                style={{ cursor: "pointer" }}
                                fontSize="small"
                                onClick={() => handleOpenPopupModal(row)}
                              />
