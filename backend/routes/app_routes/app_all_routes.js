...
const CouponsController = require("../../controllers/Users_Controllers/CouponsController");
...
router.get("/app/get/4/product/review/:product_id",App_Validator,App_All_Controllers.getLast4ProductReview)//done
router.get("/app/get/all/product/reviews/by/product_id/:product_id",App_Validator,App_All_Controllers.getAllProductReview)//done
...
router.post("/app/add/product/review/from/user/by/product_id/:product_id",App_Validator,App_All_Controllers.addProductReview);//done
...
router.get("/admin/get/coupons/code/:title/:total", App_Validator, App_All_Controllers.getCouponBycouponCode);

router.get("/app/get/coupons", App_Validator, CouponsController.allCoupons);
