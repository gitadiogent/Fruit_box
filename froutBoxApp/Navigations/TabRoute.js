...
import TrendingProducts from '../screens/TrendingProducts/TrendingProducts';
import BannerSearchResult from '../screens/SearchResult/BannerSearchResult';
...
const HomeStack = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name={navigationString.SUB_CATEGORY}
      ...
      />
      <Stack.Screen
        name={navigationString.SEARCH_RESULT}
      ...
      />
      <Stack.Screen
        name={navigationString.BANNER_SEARCH_RESULT}
        component={BannerSearchResult}
        options={{
          cardStyleInterpolator: CardStyleInterpolators.forHorizontalIOS,
        }}
      />
      ...
      <Stack.Screen
        name={navigationString.NEW_ARRIVALS}
      ...
      <Stack.Screen
        name={navigationString.ALL_PRODUCTS}
      ...
      <Stack.Screen
        name={navigationString.TRENDING_PRODUCTS}
