export const config = {
  primaryColor: '#378c11', // #007FFF blue color #1BAC4B #f40009 green color
  animationColor: '#007FFF', //#5ecb89 green color animation
  APP_ID: 'upsellz_app_001',
  APP_NAME: 'Fruit Box',
  APP_VERSION: '2.0.1',
  APP_VALIDATOR:
    'W823987erwwebfwiebiusbejwIBBASJBDHJASr18794187923984nfneiwonfrowen**0324newbndjn32x23nx23kbxibwfsljkBSDJKBFJKASBKJAfevtlmeocnnfoiqwoi',
  AFTER_SEND_MESSAGE_BOX: 'Thanks, We recevied your request',
  //   BACKEND_URI: 'https://upsellz-backend.onrender.com', //' http://192.168.43.147:5000' https://upsellz-backend.onrender.com 'https://octopus-app-i5b23.ondigitalocean.app' ,
