...
const HomeBanner = ({navigation}) => {
  ...
  const CarouselCardItem = ({ item, index }) => {
    // console.log("BANNER__",item?.selected_category)

    return (
      <View>
       {item?.selected_category ?
        <TouchableOpacity
         onPress={()=>navigation.navigate(navigationString.BANNER_SEARCH_RESULT,
          
          {searchThroughCategory:item?.selected_category,searchWithBannerTouch:true}
